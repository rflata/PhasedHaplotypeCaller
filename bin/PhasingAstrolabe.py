...
def main():
    ...
    parser.add_argument('-type','--filetype',dest='type',choices=['csv','list'],help='Limits the output to csv or list format (Default = both')
    ...
    #Starting the haplotypecaller which compares the variants obtained from the parsed VCF to the definition file.
