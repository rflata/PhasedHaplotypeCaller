...
def main():
    ...
    parser.add_argument('-loc', '--location', dest='location', required=True)
    ...
    call.buildhaplotype(vcfparse.get_hap1(), vcfparse.get_hap2(), args.location)
    #Outputting the contstructed haplotypes to file
    out = oh.output()
    regions = out.loadregions(args.location)
