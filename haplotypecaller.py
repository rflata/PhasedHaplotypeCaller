        ...
        with open('locationData.tsv') as locationData:    
            for line in locationData:
                if '#' not in line:
                    ...
                    if percentmatchhap1temp > self.percentmatchhap1[self.callhaplotypehap1] or len(intersecthap1) > len(self.hap1call[self.callhaplotypehap1]):
                        ...
                        #for key, value in self.hap1call.items():
                            #print(key,value)
                    if percentmatchhap2temp > self.percentmatchhap2[self.callhaplotypehap2] or len(intersecthap2) > len(self.hap2call[self.callhaplotypehap2]):
                        self.hap2call.clear()
